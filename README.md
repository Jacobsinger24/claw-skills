...
| [`/resume`](skills/resume/) | Professional resume writer. Five modes: build (intake + master construction), tailor (master → specific JD with honest gap analysis), bullet (workshop a single accomplishment), review (critique with triaged findings), ats (keyword + format audit). Bakes in 2025-2026 best-in-class trends (AI-augmented ATS behavior, scan-time anchors, AI-written-resume detection patterns), a packaged visual systems library (Editorial / Vendor-Native / Consulting Pitch), and a private-by-default folder. |
| [`/fantasyguru`](skills/fantasy-guru/) | Elite fantasy football research and decision-support agent. Two auto-switching modes: Pre-Draft (auction targets, sleepers, market inefficiencies, draft strategy) and In-Season (waiver wire, trade targets, weekly upside, sell-high calls). Pulls live data from FantasyPros, Yahoo, ESPN, and Fantasy Guru. Maintains persistent league state (roster, draft board, watchlist, transactions, weekly notes). Tunes recommendations to your exact league size, scoring, and budget. |
